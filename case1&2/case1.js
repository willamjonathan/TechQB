...
console.log('----------------- Nomor 2 -----------------');
console.log("Number of containers needed: ".concat(numberOfContainers));
...
for (var type in outputnumber2) {
    if (outputnumber2.hasOwnProperty(type)) {
        ...
        console.log("Fruits in the ".concat(type, " container: ").concat(fruits_1.join(', ')));
    }
}
//   -------------------------------------------------------------------------
// number 3
...
for (var type in outputnumber2) {
    if (outputnumber2.hasOwnProperty(type)) {
        ...
        console.log("Number of fruits in the ".concat(type, " container: ").concat(fruits_2.length));
    }
}
// number 4
// number 4
var a = "Banyak produk id yang sama sehingga seharusnya kalau nanti dimasukan ke database akan bisa error di primary id nya.";
var b = "Selain itu ada Apel dan apel ini dikarenakan tidak ada pengecekan untuk mengabaikan kapitalisasi";
var c = ",sehingga jadi ada redudancy data, seperti stok Apel dan apel seharusnya di jumlahkan karena masih buah yang sama";
console.log("----------------- Nomor 4 -----------------'");
console.log(a, b, c);
// number 2
